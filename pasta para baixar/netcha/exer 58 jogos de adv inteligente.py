# Eu Fiz uma coisa assim, com a tua ajuda prof:
# na verdade eu queria que o gamel avisasse só uma vez, k ele começa a ganhar 2 euros,mas vi que fica mais dificil para o jogadr, pk jà o gamel deixou de dar palpites..
...
while not acertou:
    ...
    if j == gamel:
        ...
        print(
            '\033[32mATENÇÃO! AGORA COMEÇO A GANHAR 2 EUROS:\nPOR CADA ERRO TEU: \033[31mCUIDADO JÁ SÓ TENS {}  Euros\n\033[33mAgora vai ficar mais Dificil.\n\033[44mNa verdade é Só Prestares Atenção.\033[m'.format(
                ponto + 6))
    else:
        if j < gamel:
...
'''pg que joga como usuario 
da palpites ate uma certa tentativa'''
